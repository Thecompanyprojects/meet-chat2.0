...
#define instance [XYLoadingHUD shareInstance]


@interface XYLoadingHUD ()
...
+ (instancetype) shareInstance{
    static XYLoadingHUD* _instance = nil;
...
//    view.backgroundColor = [UIColor whiteColor];
    ...
    XYLoadingView *loadingV = [[XYLoadingView alloc]initWithFrame:CGRectMake(0, 0, hudWidth, hudWidth)];
